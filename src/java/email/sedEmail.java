...
public class sedEmail {
	...
	//http://www.journaldev.com/2532/javamail-example-send-mail-in-java-smtp
	  public static void sendEmail(Session session, String toEmail, String subject, String body,String html){
		...
		public static void Email(String nomeUsuario, String emailUsuario,Integer id, String serial,String sessao) {
			...
			final String titulo = "Ativação da conta";
			final String msg = "";
			
			String url = "http://localhost:8080/login/ConfirmarContaEmail?id="+id+"&serial="+serial+"&sessao="+sessao;
			String html = " "  
					   + " "+nome+" Ainda falta um último passo<br/>"
					   + "Clique no botão abaixo para ativar sua conta<br/>"
					   + "<br/>"
					   +"<a href='"+url+"'><button>Ativar Conta</button></a>"
					   + "<br/>"
					   + "<br/>"
					   + "<br/>"
